...
public class StudyCafePassMachine {
    ...
    private Optional<StudyCafeLockerPass> selectLockerPass(StudyCafeSeatPass selectedPass) {
        ...
        Optional<StudyCafeLockerPass> lockePassCandidate = findLockerPassCandidateBy(selectedPass);

        if (lockePassCandidate.isPresent()) {
            StudyCafeLockerPass lockerPass = lockePassCandidate.get();
